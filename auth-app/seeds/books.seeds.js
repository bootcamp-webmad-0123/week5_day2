...
const connectionString = 'mongodb://127.0.0.1:27017/books-app'
...
mongoose
    ...
    .then(() => {
        return Book.insertMany(books)                               // transacción
    })
    .then(books => {
        console.log('Se han creado', books.length, 'libros')
    })
    .finally(() => {
...
//             })
//             .catch(err => console.log('Error en inserción'))
//     })
//     .catch(err => console.log('Error en conexión'))